...
const StepperController = () => {
  return (
    <div className="container flex justify-around mt-8 mb-3">
      ...
      {/* next button */}
      <button className="bg-rose-500 text-slate-900 uppercase rounded-lg py-2 px-4 hover:bg-slate-700 hover:text-white font-semibold cursor-pointer border-2 border-slate-300 transition duration-700 ease-in-out">
        Next
      </button>
    </div>
  );
